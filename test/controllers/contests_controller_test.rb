...
class ContestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contest" do
    assert_difference("Contest.count") do
      post contests_url, params: { contest: { title: @contest.title, user_id: @contest.user_id } }
    end
  ...
  test "should update contest" do
    patch contest_url(@contest), params: { contest: { title: @contest.title, user_id: @contest.user_id } }
